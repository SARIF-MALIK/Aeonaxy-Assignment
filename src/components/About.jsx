...
function About() {
  return (
    <div>
        <div className="bg-[#0F0B19] w-full text-white flex justify-center items-center">

<div className="bg-oxbg bg-contain bg-no-repeat pt-[150px] w-full">
...
<div className='power bg-[#0F0B19]' >
    <div className='w-[90%] m-auto overflow-hidden pt-36'>
    <div className='relative'>
    <img src={rec31} alt="" />
    <img src={playBtn} alt="" className='absolute top-[40%] left-[43%] w-20 md:w-36'/>
    </div>
    </div>
</div>
    </div>
